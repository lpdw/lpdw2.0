...
Project.create!(:name => 'test Project', :description => "Ceci est un test de description pour voir si tout fonctionne bien pour afficher des projets sur la page rpojet.", :link => "http://google.fr", :thumbmail => "/assets/7136563643_2fe6cd1015_z.jpg")