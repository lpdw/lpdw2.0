...
root 'pages#home'
  ...
  post '/postuler', :to => 'applicant#applicant_login', :as => 'applicant_login'
  post '/postuler/:assurance', :to => 'applicant#applicant_create_apply', :as => 'applicant_create_apply'
  get '/postuler/:assurance', :to => 'applicant#applicant_create_apply'
