...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" class="input '+classes.sFilterInput+'"/>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Affichage de _START_ à _END_ sur _TOTAL_ entrée(s)",
...
$.extend( DataTable.ext.classes, {
	...
	sFilterInput:  "input form-control input-sm",
	sLengthSelect: "input form-control input-sm"
} );
